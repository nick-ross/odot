...
describe UserSessionsController do
  ...
  describe "POST 'create'" do
    context "with correct credentials" do
      let!(:user) { User.create(first_name: "Nick", last_name: "Ross", email: "mx5433@gmail.com", password: "password1234", password_confirmation: "password1234")
}
      it "redirects to the todo list path" do
        post :create, email: "mx5433@gmail.com", password: "password1234"
        expect(response).to be_redirect
        expect(response).to redirect_to(todo_lists_path)
      end

      it "finds the user" do
        expect(User).to receive(:find_by).with({email: "mx5433@gmail.com"}).and_return(user)
        post :create, email: "mx5433@gmail.com", password: "password1234"
      end
      ...
      it "sets the remember_me token cookie if chosen" do
        expect(cookies).to_not  have_key('remember_me_token')
        post :create, email: "mx5433@gmail.com", password: "password1234", remember_me: "1"
